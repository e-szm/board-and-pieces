...
async function handleLoginSubmit(e) {
  ...
  (0,_utils_formHelper_js__WEBPACK_IMPORTED_MODULE_0__.disableForm)(this, "Logging in...");

  const email = document.getElementById("email").value.toLowerCase();
  const password = document.getElementById("password").value;

  const res = await (0,_utils_api_js__WEBPACK_IMPORTED_MODULE_2__.login)({
    email,
    password,
  });
  ...
  if (!res.ok || res.status !== 200) {
    ...
    (0,_utils_formHelper_js__WEBPACK_IMPORTED_MODULE_0__.enableForm)(this, "Log In");
    return;
  }

  (0,_utils_formHelper_js__WEBPACK_IMPORTED_MODULE_0__.clearInput)(this);
  (0,_utils_alert_js__WEBPACK_IMPORTED_MODULE_1__["default"])("success", "Login successful! You are being redirected...");
...
/******/ })()
;
//# sourceMappingURL=bundle_login.js.map